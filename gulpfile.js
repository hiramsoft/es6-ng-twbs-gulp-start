...
var jspmBundleSfx = [
    {
        id: "main", // the id to make available as a swig template variable. prefixed with 'js', e.g. 'jsmain'
        in: "bootstrap.js", // the input file in
        out: "build" // the output file (exclude the js extension)
    }
];
...
var styleBundles = [
    ...
    },
    {
        id: "scss",
        lessIn : [],
        sassIn : [baseMainPath + '/scss/app.scss'],
        cssIn : [],
        out : "scss"
    },
    {
